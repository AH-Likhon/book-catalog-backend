...
const createUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const encryptPassword = yield (0, auth_utils_1.hashPassword)(password);
    const updatedData = Object.assign(Object.assign({}, others), { password: encryptPassword });
...
const loginUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const checkPasswordMatched = yield (0, auth_utils_1.decryptPassword)({
